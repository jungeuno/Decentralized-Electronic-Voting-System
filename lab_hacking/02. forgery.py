...
class Tab3(QWidget):
    def __init__(self, devs):
        ...
        self.forgery_button = QPushButton('위조')
        self.forgery_button.clicked.connect(self.forgery)

        self.layout = QVBoxLayout()
        self.layout.addWidget(self.forgery_button)
